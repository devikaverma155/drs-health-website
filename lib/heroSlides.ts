...
export const DEFAULT_HERO_SLIDES: HeroSlideConfig[] = [
  {
    ...
    image: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/ChatGPT-Image-Mar-9-2026-02_42_21-PM.png',
  ...
  },
  {
    ...
    image: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/Gemini_Generated_Image_osb8udosb8udosb8.png',
  ...
  },
  {
    ...
    image: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/Gemini_Generated_Image_j5ys5aj5ys5aj5ys.png',
  ...
  },
  {
    ...
    image: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/ChatGPT-Image-Mar-9-2026-02_29_22-PM.png',
...
export const DEFAULT_SHOP_BANNER_SLIDES: ShopBannerSlideConfig[] = [
  {
    ...
    ctaLabel: 'Shop Now',
    ctaHref: '/shop',
    imageUrl: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/ChatGPT-Image-Mar-9-2026-02_42_21-PM.png',
    imageAlt: 'Premium Wellness Range',
    variant: 'primary',
  },
  {
    ...
    ctaLabel: 'Shop',
    ctaHref: '/shop',
    imageUrl: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/Gemini_Generated_Image_osb8udosb8udosb8.png',
    imageAlt: 'Natural Health Solutions',
    variant: 'primary',
  },
  {
    ...
    ctaLabel: 'Free Consultation',
    ctaHref: '/consultation',
    imageUrl: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/Gemini_Generated_Image_j5ys5aj5ys5aj5ys.png',
    imageAlt: 'Holistic Wellness',
    variant: 'primary',
  },
  {
    ...
    ctaLabel: 'Shop',
    ctaHref: '/shop',
    imageUrl: 'https://9gk.22b.myftpupload.com/wp-content/uploads/2026/03/ChatGPT-Image-Mar-9-2026-02_29_22-PM.png',
    imageAlt: 'Authentic Ayurvedic Care',
    variant: 'primary',
  },
];
